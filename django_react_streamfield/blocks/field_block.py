...
class FieldBlock(Block):
    ...
    def render_form(self, value, prefix="", errors=None):
        ...
        return render_to_string(
            "django_react_streamfield/block_forms/field.html",
            {
                "name": self.name,
    ...
    def value_from_datadict(self, data, files, prefix):
        return self.value_from_form(
            self.field.widget.value_from_datadict(
                {"value": data.get("value", self.get_default())}, files, "value"
            )
        )
    ...
    def prepare_value(self, value, errors=None):
        ...
        # if isinstance(self, RichTextBlock) and isinstance(widget, DraftailRichTextArea):
    ...
    def definition(self):
        ...
        definition["html"] = self.render_form(
            self.get_default(), prefix=self.FIELD_NAME_TEMPLATE
        )
...
class TextBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from django_react_streamfield.admin_widgets import AdminAutoHeightTextInput
...
class ChoiceBlock(FieldBlock):
    ...
    def deconstruct(self):
        ...
        """
        return (
            "django_react_streamfield.blocks.ChoiceBlock",
            [],
...
DECONSTRUCT_ALIASES = {
    cls: "django_react_streamfield.blocks.%s" % cls.__name__ for cls in block_classes
}
